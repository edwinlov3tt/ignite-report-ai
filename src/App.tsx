...
import { ExtractorSuggestionsPage } from '@/pages/admin/ExtractorSuggestionsPage'
    ...
    <>
      <Routes>
        ...
        <Route element={<AdminLayout />}>
          ...
          <Route path="/schema-admin/sources" element={<SourcesPage />} />
          <Route path="/schema-admin/extractor-suggestions" element={<ExtractorSuggestionsPage />} />
        </Route>
      </Routes>
